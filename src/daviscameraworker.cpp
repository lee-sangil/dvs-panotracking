...
DAVISCameraWorker::DAVISCameraWorker(TrackingWorker *worker):ugly_(worker)
{
...
//    caerDeviceConfigSet(davis240_handle_, DAVIS_CONFIG_APS, DAVIS_CONFIG_APS_FRAME_DELAY, 0);
    ...
    caerDeviceConfigSet(davis240_handle_, DAVIS_CONFIG_IMU, DAVIS_CONFIG_IMU_RUN_ACCELEROMETER, false);
    caerDeviceConfigSet(davis240_handle_, DAVIS_CONFIG_IMU, DAVIS_CONFIG_IMU_RUN_GYROSCOPE, false);
    caerDeviceConfigSet(davis240_handle_, DAVIS_CONFIG_IMU, DAVIS_CONFIG_IMU_RUN_TEMPERATURE, false);
